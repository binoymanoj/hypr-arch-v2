...
run_command "Installing AUR packages" yay -S --noconfirm brave-bin bibata-cursor-theme  zsh-completions nvm eog wofi-emoji ags-hyprpanel-git ghostty deepin-gtk-theme juno-ocean-gtk-theme-git
